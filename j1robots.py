...
inputSource = "buttons" # variable I'll use to check different input sources for debugging, testing and production; "console" and "buttons" only in use so far
simulate = False
...
blueStorage = {   "1":tokenPosition(xIn = -113  , yIn = 5   , colorIn = "blue"),
			      ...
			      "5":tokenPosition(xIn = -153.5, yIn = 32.5, colorIn = "blue"),
			      "6":tokenPosition(xIn = -187  , yIn = 25.5, colorIn = "blue")
}
